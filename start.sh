...
export BOT_PRESENCE_STATUS="${BOT_PRESENCE_STATUS:-online}"
[ -n "$BOT_PRESENCE_ACTIVITY_TYPE" ]       && export BOT_PRESENCE_ACTIVITY_TYPE
[ -n "$BOT_PRESENCE_ACTIVITY_NAME" ]       && export BOT_PRESENCE_ACTIVITY_NAME
[ -n "$BOT_PRESENCE_ACTIVITY_STREAM_URL" ] && export BOT_PRESENCE_ACTIVITY_STREAM_URL
...
[ -n "$BACKEND_API_ADMIN_USER_IDS" ] && export BACKEND_API_ADMIN_USER_IDS
